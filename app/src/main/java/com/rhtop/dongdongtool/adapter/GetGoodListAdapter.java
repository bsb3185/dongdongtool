package com.rhtop.dongdongtool.adapter;
...
public class GetGoodListAdapter extends BaseAdapter {

	private Context context;
	private LayoutInflater inflater;
	private ArrayList<ArrayList<String>> lists;
	
	public GetGoodListAdapter(Context context, ArrayList<ArrayList<String>> lists) {
		super();
	...
	public View getView(int index, View view, ViewGroup arg2) {
		...
		if(view == null){
			view = inflater.inflate(R.layout.getgood_list_item, null);
		}
